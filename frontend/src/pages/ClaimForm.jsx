  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response && response.status === 429) {
        ...
        setAlertInfo({ type: 'success', message: 'Klaim berhasil dikirim dan sedang dianalisis oleh A.U.R.A.' });
        // Reset form
        setComplaint('');
        removeImage();
      } else {
      ...
      if (isRateLimited) {
        ...
        setAlertInfo({ type: 'success', message: '[Mock] Klaim berhasil dikirim! Menunggu analisis A.U.R.A.' });
        setComplaint('');
        removeImage();
      }
    } finally {
